```mermaid
%%{init: {'themeVariables': {'clusterBkg': '#0004', 'titleColor': 'transparent', 'edgeLabelBackground': '#505'}}}%%
flowchart BT
    ...
    %% Document subtree
    subgraph DocumentRoot["document"]
    ...
    %% Counter subtree
    subgraph CounterRoot["counter"]
        VAR_counter__8[("counter")]:::root_variable_class
        CALL_Math_sum__9["Math/sum(..)"]
        LATEST__10["LATEST"]
        NUM_0__11["0"]
        GET_increment_button_event_press__12[".event.press"]
    ...
    %% THEN subtree inside counter logic
    subgraph THEN__13["THEN"]
        ...
        GET_increment_button_event_press__12 ==> THEN_IN__14
        THEN_OUT__16 ==> |"2"| LATEST__10
    end

    %% Increment button subtree
    subgraph IncrementButtonRoot["increment_button"]
        ...
        VAR_increment_button__17 --> GET_increment_button_event_press__12
