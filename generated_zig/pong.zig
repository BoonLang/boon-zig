...
const semantic_source_map = [_]SourceMapEntry{
    .{ .semantic_id = "sources.keyboard.event.key_down", .source_path = "examples/source_physical/pong/pong.bn", .boon_start = 44, .boon_end = 50, .generated_start = 621, .generated_end = 689, .source_slot_id = 0 },
    .{ .semantic_id = "sources.frame.event.tick", .source_path = "examples/source_physical/pong/pong.bn", .boon_start = 79, .boon_end = 85, .generated_start = 689, .generated_end = 750, .source_slot_id = 1 },
};
...
var generated_physical_hold_12_updates = [_]physical_ir.ValueSlotId{
    11,
};

var generated_physical_hold_22_updates = [_]physical_ir.ValueSlotId{
    21,
};
...
var generated_physical_state_slots = [_]physical_ir.StateSlot{
    .{ .id = 0, .semantic_id = "hold.last_key", .flow_node = 12 },
...
pub fn main(init: std.process.Init) !void {
    ...
    var app: AppState = .{};
    app.dispatchEvent(0, .{ .text = "Enter" });
