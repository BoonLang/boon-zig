...
const semantic_source_map = [_]SourceMapEntry{
    .{ .semantic_id = "increment_button.event.press", .source_path = "fixtures/generic_apps/source_counter/app.bn", .boon_start = 34, .boon_end = 40, .generated_start = 621, .generated_end = 686, .source_slot_id = 0 },
};
